...
class EstadoPedidoSeeder extends Seeder
{
    public function run(): void
    {
        $estados = [
            ...
            ['nombre' => 'En camino',        'descripcion' => 'El repartidor recogió el pedido y va en camino.',   'color' => '#03A9F4', 'orden' => 4],
            ['nombre' => 'Entregado',        'descripcion' => 'El pedido fue entregado al cliente satisfactoriamente.', 'color' => '#4CAF50', 'orden' => 5],
            ['nombre' => 'Cancelado',        'descripcion' => 'El pedido fue cancelado.',                          'color' => '#F44336', 'orden' => 6],
        ];
